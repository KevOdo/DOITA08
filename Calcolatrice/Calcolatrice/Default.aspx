    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnPiu" runat="server" Text="+" OnClick="btnPiu_Click" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnMeno" runat="server" Text="-" OnClick="btnMeno_Click" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnDiviso" runat="server" Text="/" OnClick="btnDiviso_Click" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnPer" runat="server" Text="*" OnClick="btnPer_Click" />
                </td>
            </tr>
