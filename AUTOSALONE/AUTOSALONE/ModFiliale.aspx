<%@ Page Title="" Language="C#" MasterPageFile="~/Autosalone.master" AutoEventWireup="true" CodeFile="ModFiliale.aspx.cs" Inherits="_ModFiliale" %>
    ...
    <section class="container">
        ...
        <div class="row d-flex justtify-content-center">
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h5>Seleziona Filiale:</h5>
                        <div class="scroll">
                            <asp:GridView ID="grdFiliali" runat="server" AutoGenerateColumns="False" DataKeyNames="chiave" DataSourceID="sdsFiliali" CssClass="table table-striped table-sm" OnSelectedIndexChanged="grdFiliali_SelectedIndexChanged">
                                <Columns>
                                    <asp:CommandField ShowSelectButton="true" />
                                    <asp:BoundField DataField="NOMEFILIALE" HeaderText="NOME" SortExpression="NOMEFILIALE"></asp:BoundField>
