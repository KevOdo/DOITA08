...
<body>
    <form id="form1" runat="server">
        <div class="container griglia" id="a">
            <div class="row myBlue" id="b">
                <div class="col"></div>
                <div class="col">A </div>
                <div class="col">B </div>
                <div class="col">C </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col">
                    <asp:Label ID="lblColonna" runat="server" Text="Colonna"></asp:Label>
                </div>
                <div class="col">
                    <asp:Label ID="lblRiga" runat="server" Text="Riga"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <asp:TextBox ID="txtColonna" runat="server"></asp:TextBox>
                </div>
                <div class="col">
                    <asp:TextBox ID="txtRiga" runat="server"></asp:TextBox>
                </div>
            </div>

            <div>
                <asp:Button ID="bntHit" runat="server" Text="Colpisci" OnClick="bntHit_Click" />
            </div>
